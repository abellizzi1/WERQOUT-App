package com.exp2.application.test;
...
public class Controller {
	...
	public String postTest2(@RequestBody Data Data) {
		//TODO
		return String.format("Hello, %s! You sent a post request with a requestbody!", Data.getMessage());
	}
